...
//        barChart = (BarChart) findViewById(R.id.bargraph);
        ...
        barChart = (BarChart) findViewById(R.id.hbargraph);
        ...
        DatabaseAccess datacountM = DatabaseAccess.getInstance(Graph_Kagawad.this,"voters.db"); //count the names
        datacountM.open();
    ...
    public void saveImageButton(){
        graph_layout = (LinearLayout) findViewById(R.id.kgraphview_layout);
        Button saveImagebutton = (Button) findViewById(R.id.kssbuton);
        saveImagebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder setbuilder = new AlertDialog.Builder(Graph_Kagawad.this);
                setbuilder.setTitle("Enter File Name:");
                final EditText filenameEdit = new EditText(Graph_Kagawad.this);
                ...
                setbuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        if (!filename.isEmpty()){
                            ...
                            Toast.makeText(Graph_Kagawad.this, "Enter a file name", Toast.LENGTH_SHORT).show();
                        }
                        dialog.dismiss();
                    }
                });
    ...
    private void saveImage(View v,String File_name){
        ...
        try {
            ...
            Toast.makeText(Graph_Kagawad.this, "Image saved", Toast.LENGTH_SHORT).show();

        } catch (Throwable e) {
            Toast.makeText(Graph_Kagawad.this, "Image not save", Toast.LENGTH_SHORT).show();
