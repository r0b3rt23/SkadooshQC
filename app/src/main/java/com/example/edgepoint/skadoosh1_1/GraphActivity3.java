...
public class GraphActivity3 extends AppCompatActivity {
    ...
    public static final String URL_COUNT = "http://ramores.com/rema/php_skadoosh/getCountPrecinct.php";
    public static final String URL_LineCOUNT = "http://ramores.com/rema/php_skadoosh/getCountLinePrecinct.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                DatabaseAccess databaseUserAccess = DatabaseAccess.getInstance(GraphActivity3.this,"voters.db");
    ...
    public void graphactivity3(){
        ...
        city_spinner = findViewById(R.id.city_spinner3);
        ...
        city_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                DatabaseAccess databaseAccessBarangay = DatabaseAccess.getInstance(GraphActivity3.this,"voters.db");
                ...
                ArrayAdapter<String> adapterBarangay = new ArrayAdapter<>(GraphActivity3.this,android.R.layout.simple_spinner_item, barangays);
        ...
        barangay_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                DatabaseAccess databaseAccessPrecinct = DatabaseAccess.getInstance(GraphActivity3.this,"voters.db");
                databaseAccessPrecinct.open();
                List<String> precinct = databaseAccessPrecinct.getPrecinct(citySpinner,Bgypsin,"City_Municipality=? AND Barangay=?","Precinct");
    ...
    public void graph(){
            ...
            case "ViceMayor":
                switch (citySpinner){
                    case "Candelaria":
                        ...
                        labels.add("SUAYAN");
                        labels.add("Indefinite");
                        table_graph = "candelaria_vicemayor_graph";
                        break;
                    ...
                    case "Dolores":
                        ...
                        labels.add("MENDOZA");
                        labels.add("Indefinite");
                        table_graph = "dolores_vicemayor_graph";
                        break;

                    case "Lucena City":
                        labels.add("ALCANTARA");
                        labels.add("CASTILLO");
                        labels.add("TALABONG");
                        labels.add("TALAGA");
                        labels.add("Indefinite");
                        table_graph = "lucena_vicemayor_graph";
                        break;
                    ...
                    case "San Antonio":
                        ...
                        labels.add("VESLINO");
                        labels.add("Indefinite");
                        table_graph = "sanantonio_vicemayor_graph";
                        break;

                    case "Sariaya":
                        labels.add("DE LA PENA");
                        labels.add("TOLENTINO");
                        labels.add("VENDIOLA");
                        labels.add("Indefinite");
                        table_graph = "sariaya_vicemayor_graph";
                        break;
                    ...
                    case "Tiaong":
                        ...
                        labels.add("UMALI");
                        labels.add("Indefinite");
                        table_graph = "tiaong_vicemayor_graph";
                        break;
        ...
        if ( checkNetworkConnection()){
            ...
            CountInServer(ListSpinner1,Prcntpsin,table_graph,citySpinner,"online", "withoutMissing");
        }
        else
        {
            CountInLocal(labels,ListSpinner1,Prcntpsin,table_graph,"offline",citySpinner);
        }

    }

    public void CountInLocal(List<String> labelsLocal,String candidateSpinner, String precinctSpinner, String table_graph_local, String connection_local, String cityIntent){
        List<Integer> count = new ArrayList<>();
        List<String> partyList = new ArrayList<>();

        if (candidateSpinner.equals("PartyList")){
            DatabaseAccess createPartyListTable = DatabaseAccess.getInstance(GraphActivity3.this,"voters.db");
            createPartyListTable.open();
            createPartyListTable.CreateDynamicTables(table_graph_local);
            createPartyListTable.close();
        }

        DatabaseAccess datacount = DatabaseAccess.getInstance(GraphActivity3.this,"voters.db"); //count the names
        datacount.open();
        if (candidateSpinner.equals("PartyList")){
            partyList = datacount.getDistinctName();
            for (int i=0; i<partyList.size();i++)
            {
                count.add(datacount.getcountnamePartylist3(partyList.get(i),candidateSpinner,cityIntent, precinctSpinner));
            }
        }
        else{
            for (int i=0; i<labelsLocal.size();i++)
            {
                if (candidateSpinner.equals("BoardMember")){
                    count.add(datacount.getcountname3("true",labelsLocal.get(i),cityIntent,precinctSpinner));
                }
                else {count.add(datacount.getcountname3(labelsLocal.get(i),candidateSpinner,cityIntent,precinctSpinner));}
            }
        }
        datacount.close();

        DatabaseAccess insertdata = DatabaseAccess.getInstance(GraphActivity3.this,"voters.db"); //insert data
        insertdata.open();
        if (candidateSpinner.equals("PartyList")){
        ...
        if (candidateSpinner.equals("PartyList")){
            DatabaseAccess createPartyListTableSort = DatabaseAccess.getInstance(GraphActivity3.this,"voters.db");
            createPartyListTableSort.open();
            createPartyListTableSort.CreateDynamicTables("sample_table");
            createPartyListTableSort.close();

            DatabaseAccess insertAscending = DatabaseAccess.getInstance(GraphActivity3.this,"voters.db"); //insert data
        ...
        if (candidateSpinner.equals("BoardMember")) {
            ...
            openGraph3(candidateSpinner, "sample_table", connection_local,cityIntent);
        }
        else {
            openGraph3(candidateSpinner, table_graph_local, connection_local,cityIntent);
        }
    }
    ...
    public void Mgraph(){
            ...
            case "ViceMayor":
                switch (citySpinner){
                    case "Candelaria":
                        ...
                        mlabels.add("Indefinite");
                        mlabels.add("Missing System");
                        table_graph = "candelaria_vicemayor_Mgraph";
                        break;
                    ...
                    case "Dolores":
                        ...
                        mlabels.add("Indefinite");
                        mlabels.add("Missing System");
                        table_graph = "dolores_vicemayor_Mgraph";
                        break;
                    ...
                    case "Lucena City":
                        ...
                        labels.add("Indefinite");
                        labels.add("");
                        mlabels.add("ALCANTARA");
                        mlabels.add("CASTILLO");
                        mlabels.add("TALABONG");
                        mlabels.add("TALAGA");
                        mlabels.add("Indefinite");
                        mlabels.add("Missing System");
                        table_graph = "lucena_vicemayor_Mgraph";
                        break;
                    ...
                    case "San Antonio":
                        ...
                        labels.add("Indefinite");
                        labels.add("");
                        mlabels.add("PILLERBA");
                        mlabels.add("VESLINO");
                        mlabels.add("Indefinite");
                        mlabels.add("Missing System");
                        table_graph = "sanantonio_vicemayor_Mgraph";
                        break;
                    ...
                    case "Sariaya":
                        ...
                        labels.add("Indefinite");
                        labels.add("");
                        mlabels.add("DE LA PENA");
                        mlabels.add("TOLENTINO");
                        mlabels.add("VENDIOLA");
                        mlabels.add("Indefinite");
                        mlabels.add("Missing System");
                        table_graph = "sariaya_vicemayor_Mgraph";
                        break;
                    ...
                    case "Tiaong":
                        ...
                        mlabels.add("Indefinite");
                        mlabels.add("Missing System");
                        table_graph = "tiaong_vicemayor_Mgraph";
                        break;
                }
                break;
        ...
        if ( checkNetworkConnection()){
            CountInServer(ListSpinner1,Prcntpsin,table_graph,citySpinner,"online","Missing");
        }
        else
        {
            MCountInLocal(labels,mlabels,ListSpinner1,Prcntpsin,table_graph,"offline",citySpinner);
        }

    }

    public void MCountInLocal(List<String> labelsLocal,List<String> MlabelsLocal,String candidateSpinner,String precinctSpinner, String table_graph_local,String connection_local, String cityIntent) {
        List<Integer> count = new ArrayList<>();
        ...
        if (candidateSpinner.equals("PartyList")){
            ...
            {
                count.add(datacount.getcountnamePartylist3(MpartyList.get(i),candidateSpinner,cityIntent, precinctSpinner));
            }
        }
        else{
            for (int i=0; i<labelsLocal.size();i++)
            {
                if (candidateSpinner.equals("BoardMember")){
                    if (labelsLocal.get(i).equals("")){
                        count.add(datacount.getcountname3(labelsLocal.get(i),"ALCALA",cityIntent, precinctSpinner));
                    }
                    else count.add(datacount.getcountname3("true",labelsLocal.get(i),cityIntent, precinctSpinner));
                }
                else {count.add(datacount.getcountname3(labelsLocal.get(i),candidateSpinner,cityIntent, precinctSpinner));}
            }
        }
        ...
        if (candidateSpinner.equals("BoardMember")) {
            ...
            openMissingGraph3(candidateSpinner, "sample_table", connection_local,cityIntent);
        }
        else {
            openMissingGraph3(candidateSpinner ,table_graph_local,connection_local,cityIntent);
        }
    }

    public void CountInServer(final String candidateSpinner,  final String precinctSpinner, final String table_graph_server,final String cityIntent,final String connection_server, final String generate){
                                ...
                                switch (generate){
                                    case "withoutMissing":
                                        if (candidateSpinner.equals("BoardMember")) {
                                            ...
                                            openGraph3(candidateSpinner, "sample_table", connection_server,cityIntent);
                                        }
                                        else {
                                            openGraph3(candidateSpinner, table_graph_server,connection_server,cityIntent);
                                        }
                                        break;
                                    case "Missing":
                                        if (candidateSpinner.equals("BoardMember")) {
                                            ...
                                            openMissingGraph3(candidateSpinner, "sample_table", connection_server,cityIntent);
                                        }
                                        else {
                                            openMissingGraph3(candidateSpinner, table_graph_server,connection_server,cityIntent);
                                        }
                                        break;
                                }
                            }
    ...
    public void openGraph3(String label, String table_graph, String connection, String city){
    ...
    public void openMissingGraph3(String label, String table_graph, String connection, String city){
    ...
    public void Linegraph(){
        ...
        DatabaseAccess databaseAccessBatch = DatabaseAccess.getInstance(GraphActivity3.this,"voters.db");
        ...
        if (BatchCount == 1){
            ...
            if ( checkNetworkConnection()){
                ...
                if (ListSpinner1.equals("PartyList")) {
                    progressDialog.dismiss();
                    Toast.makeText(GraphActivity3.this, "Chart not available at the moment", Toast.LENGTH_SHORT).show();
                }
                else {

                    for (int x = 1; x <= BatchCount; x++) {
                        String batchName = "batch" + x + "_list";
                        CountLineServer(ListSpinner1, Prcntpsin, "LineGraph_pct", batchName, citySpinnerLine);
                    }
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            progressDialog.dismiss();
                            openLineGraph(ListSpinner1, "LineGraph_pct", citySpinnerLine);
                        }
                    }, 10000);
                }
            }
            ...
            {
                progressDialog.dismiss();
                Toast.makeText(GraphActivity3.this, "Connect to network to generate line chart.", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void CountLineServer(final String canSpinner, final String precinctSpinner, final String table_lineGraph,final String batch_name,final String cityIntent){
        RequestQueue queue = Volley.newRequestQueue(GraphActivity3.this);
...
//                        progressDialog.dismiss();
    ...
    private void homeButton() {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(GraphActivity3.this, MainActivity.class);
    ...
    private void homeButton2() {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(GraphActivity3.this, Main2Activity.class);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(i);
                finish();
            }
