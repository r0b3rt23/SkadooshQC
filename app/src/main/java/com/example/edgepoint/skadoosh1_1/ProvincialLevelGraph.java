...
public class ProvincialLevelGraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_provincial_level_graph);

        registerReceiver(broadcastReceiver, new IntentFilter(ConnectivityManager.CONNECTIVITY_ACTION));

        progressDialog = new ProgressDialog(ProvincialLevelGraph.this);
        progressDialog.setMessage("Generating Graph...");

        graph_spinner = findViewById(R.id.provincial_spinner);
        ...
        DatabaseAccess databaseUserAccess = DatabaseAccess.getInstance(ProvincialLevelGraph.this,"voters.db");
    ...
    public void generateGraph(){
        ...
        Button generategraphbtn =  findViewById(R.id.generate_prov);
    ...
    public void CountInLocal(List<String> labelsLocal,String candidateSpinner, String table_graph_local, String connection_local){
        ...
        if (candidateSpinner.equals("PartyList")){
            DatabaseAccess createPartyListTable = DatabaseAccess.getInstance(ProvincialLevelGraph.this,"voters.db");
            createPartyListTable.open();
            createPartyListTable.CreateDynamicTables(table_graph_local);
            createPartyListTable.close();
        }

        DatabaseAccess datacount = DatabaseAccess.getInstance(ProvincialLevelGraph.this,"voters.db"); //count the names
        datacount.open();
        ...
        DatabaseAccess insertdata = DatabaseAccess.getInstance(ProvincialLevelGraph.this,"voters.db"); //insert data
        insertdata.open();
        if (candidateSpinner.equals("PartyList")){
        ...
        if (candidateSpinner.equals("PartyList")){
            DatabaseAccess createPartyListTableSort = DatabaseAccess.getInstance(ProvincialLevelGraph.this,"voters.db");
            createPartyListTableSort.open();
            createPartyListTableSort.CreateDynamicTables("sample_table");
            createPartyListTableSort.close();

            DatabaseAccess insertAscending = DatabaseAccess.getInstance(ProvincialLevelGraph.this,"voters.db"); //insert data
    ...
    public void generateMissingGraph(){
        ...
        Button miss_generategraphbtn = findViewById(R.id.generate_provm2);
    ...
    public void CountInServer(final String candidateSpinner, final String table_graph_server, final String connection_server,final String generate){
        RequestQueue queue = Volley.newRequestQueue(ProvincialLevelGraph.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_COUNT,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (countArr != 0){
                                ...
                                Toast.makeText(ProvincialLevelGraph.this, "Data is Empty!", Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ProvincialLevelGraph.this, error+" ", Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
    ...
    public void generateLineGraph(){
        Button LineGraph = findViewById(R.id.linechartprov_btn);
    ...
    public void Linegraph(){
        ...
        DatabaseAccess databaseAccessBatch = DatabaseAccess.getInstance(ProvincialLevelGraph.this,"voters.db");
        ...
        if (BatchCount == 1){
            progressDialog.dismiss();
            Toast.makeText(ProvincialLevelGraph.this, "Cannot Generate Line Graph. Batch should be more than 1.", Toast.LENGTH_SHORT).show();
        }
        else {
            if ( checkNetworkConnection()){
                ...
                if (ListSpinner.equals("PartyList")){
                    progressDialog.dismiss();
                    Toast.makeText(ProvincialLevelGraph.this, "Chart not available at the moment", Toast.LENGTH_SHORT).show();
                }
                else {
            ...
            {
                progressDialog.dismiss();
                Toast.makeText(ProvincialLevelGraph.this, "Connect to network to generate line chart.", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void CountLineServer(final String canSpinner, final String table_lineGraph,final String batch_name){
        ...
        StringRequest stringRequestLine = new StringRequest(Request.Method.POST, URL_LineCOUNT,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ProvincialLevelGraph.this, "Sending Failed! No Internet Connection.", Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
    ...
    private void homeButton() {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProvincialLevelGraph.this, MainActivity.class);
    ...
    private void homeButton2() {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProvincialLevelGraph.this, Main2Activity.class);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(i);
                finish();
            }
