...
//                    Toast.makeText(getApplicationContext(), lenghtCount+" uncheck", Toast.LENGTH_LONG).show();
    ...
    public void savingtoDatabase(String voters,String governor,String vicegovernor,String congressman,String mayor,String alcalaBokal,String alejandrinoBokal, String casullaBokal,
        ...
        if(checkDuplicate == true){
            boolean submitUpdate = databaseAccessSubmit.updateUnregData(voters,governor,vicegovernor,congressman,mayor,alcalaBokal,alejandrinoBokal,casullaBokal,
            ...
            boolean submitInsert= databaseAccessSubmit.insertOnConflictUnregData(voters,governor,vicegovernor,congressman,mayor,alcalaBokal,alejandrinoBokal,
