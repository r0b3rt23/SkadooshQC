...
public class QuestionForm_Unreg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_form__unreg);
...
//        partylist_tv = (TextView) findViewById(R.id.partylist_id);
        ...
        DatabaseAccess databaseAccessDeceased = DatabaseAccess.getInstance(QuestionForm_Unreg.this,"voters.db");
        databaseAccessDeceased.open();
        String deceased = databaseAccessDeceased.getUnregDeceasedStr(votersname_form);
    ...
    public void restoreDeceased(){
        AlertDialog.Builder confirmationDialog = new AlertDialog.Builder(QuestionForm_Unreg.this);
        ...
        confirmationDialog.setCancelable(false)
                .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        progressDialog = new ProgressDialog(QuestionForm_Unreg.this);
    ...
    public void showDeceasedDialog(){
        ...
        confirmationDialog.setCancelable(false)
                .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
                        AlertDialog.Builder setbuilder = new AlertDialog.Builder(QuestionForm_Unreg.this);
                        setbuilder.setTitle("Enter Encoder's Name");
                        final EditText encoder = new EditText(QuestionForm_Unreg.this);
    ...
    public void QuestionForm(String votersName){
        ...
        for (int x = 4; x < 63; x++) {
            String StringList = databaseAccessInfo.getUnregList(votersName, city_form, barangay_form, precinct_form, "VotersName=? AND City_Municipality=? AND Barangay=? AND Precinct=?", null, x);
            if (x == 4 || x == 5 || x >= 10) {
    ...
    public void BirthDatePicker(final String bdstring, final String agestring){
        ...
        mDisplayDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(QuestionForm_Unreg.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, mDateSetListener, year,month,day);
                ...
                setbuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        if (!encodername.isEmpty()) {
                            ...
                            String facebook_save = facebook.getText().toString();
//                            String PartyList = PartyListtextView.getText().toString();
                            ...
                            savingtoDatabase(votersname_form, nameListgovernor[0], nameListvicegovernor[0], save_congressman, nameListmayor[0],alcalaBokal,
                                    ...
                                    PartyList, encodername,contentPhone,address_submit,stringBirthday,age_submit,email_submit,facebook_save,high_education,annual_income,nameListvicemayor[0],
...
//                            }
    ...
    public void savingtoDatabase(String voters,String governor,String vicegovernor,String congressman,String mayor,String alcalaBokal,String alejandrinoBokal, String casullaBokal,String gonzalesBokal,
        ...
        DatabaseAccess databaseAccessSubmit = DatabaseAccess.getInstance(QuestionForm_Unreg.this,"voters.db");
        databaseAccessSubmit.open();

        boolean checkDuplicate = databaseAccessSubmit.checkDuplicateUpload(votersname_form);

        if(checkDuplicate == true){
            boolean submitUpdate = databaseAccessSubmit.updateUnregData(voters,governor,vicegovernor,congressman,mayor,alcalaBokal,alejandrinoBokal,casullaBokal,gonzalesBokal,liwanagBokal,
                    sioBokal,talagaBokal,tanadaBokal,indicator_on_off,deceased_yes_no,partylist,encodername,contact,address_save,birthday_save,age_save,email_save,facebook_save,education_save,income_save,vicemayor,
            ...
            if(submitUpdate == true) {
                Toast.makeText(QuestionForm_Unreg.this,"Data Saved.",Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
                finish();
            }
            else {
                Toast.makeText(QuestionForm_Unreg.this, "Data not Save", Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }
        }
        else {
            boolean submitInsert= databaseAccessSubmit.insertOnConflictUnregData(voters,governor,vicegovernor,congressman,mayor,alcalaBokal,alejandrinoBokal,casullaBokal,gonzalesBokal,liwanagBokal,
                    sioBokal,talagaBokal,tanadaBokal,indicator_on_off,deceased_yes_no,partylist,encodername,contact,address_save,birthday_save,age_save,email_save,facebook_save,education_save,income_save,vicemayor,
                    educ_scholar_year1,educ_scholar_php1,medical_assistance_year1,medical_assistance_php1,agriculture_year1,agriculture_php1,cooperative_year1,cooperative_php1,
                    educ_scholar_year2,educ_scholar_php2,medical_assistance_year2,medical_assistance_php2,agriculture_year2,agriculture_php2,cooperative_year2,cooperative_php2,
                    educ_scholar_year3,educ_scholar_php3,medical_assistance_year3,medical_assistance_php3,agriculture_year3,agriculture_php3,cooperative_year3,cooperative_php3,
            ...
            if(submitInsert == true) {
                ...
                Toast.makeText(QuestionForm_Unreg.this, "Data not Submitted", Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }
        }
